...
AProjectCharlieCharacter::AProjectCharlieCharacter()
{
	...
	*/
	...
	// FPCameraDefaultLocation = FVector(0.0f, 8.699828f, 0.0f); // This is the old value, here for safe keeping
...
void AProjectCharlieCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	*/
	...
	PlayerInputComponent->BindAction("Sprint", IE_Pressed, this, &AProjectCharlieCharacter::StartSprint);
...
/*
	...
	======================================================================
*/
void AProjectCharlieCharacter::StartSprint()
{
...
/*
	...
	This function delegates execution for networking. The LocalEquipWeapon
	function below contains the actual equip logic.
	======================================================================
*/
...
void AProjectCharlieCharacter::Tick(float DeltaTime) {
	...
	{
		// Logic for matching rear and front sights
